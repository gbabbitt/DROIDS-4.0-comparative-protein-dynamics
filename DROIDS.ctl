query	1ubqcopy	 # Protein Data Bank ID for query structure
reference	1ubq	 # Protein Data Bank ID for reference structure (or neutral model)
length	76	 # number of amino acids on chain
num_chains	1	 # number chains in PDB structure
homology	strict	 # homology as 'strict' or 'loose'
...
color_scheme	br	 # output color scheme (stoplight=red-green, temperature=blue-red)
shape	y	 # option to analyze protein shape as well as fluctuation
