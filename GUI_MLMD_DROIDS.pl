...
# Buttons
my $varlistButton = $mw -> Button(-text => "create list of .pdb files for copies and variants to analyze", 
				-command => \&varlist
...
print "for example\n\n";
print "PDB_IDs\n";
print "1ubq_unbound_validation1\n";
print "1ubq_unbound_validation2\n";
print "1ubq_F34G\n";
print "1ubq_H57D\n";
print "etc...\n\n\n";
...
system "perl teLeap_proteinQuery_deploy.pl\n";
...
# NOTE $queryID changed to $fileIDq below
