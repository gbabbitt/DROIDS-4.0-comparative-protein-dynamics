...
if ($method_bnp == 1){
 ...
 for (my $r = 0; $r<$lengthID; $r++){
   ...
   print Rinput "dataTvect = read.table('indAAtrain_flux+corr/fluxcorrAA_$refID"."_$r.txt', header = TRUE)\n";
   ...
   print Rinput "dataDvect = read.table('testingData_$fileIDq/indAAtest_flux+corr/fluxcorrAA_$fileIDq"."_$r.txt', header = TRUE)\n";
