...
if($attr eq "rmsf" & $scaleType eq "auto") {$max_val = $max_abs_val; $min_val = 0;}
...
if($attr eq "rmsf"){copy("./attribute_files/$output_file", "ChimeraXvis/attributeRMSF.dat");}
...
if($attr eq "rmsf"){print CTL "attr_file\t"."ChimeraXvis/attributeRMSF.dat\n"; print CTL "attr\t"."rmsf\n"; print CTL "palette\t"."bluered\n";}
